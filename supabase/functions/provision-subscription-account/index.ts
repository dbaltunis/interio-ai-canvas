...
serve(async (req) => {
  ...
  try {
    ...
    const ownerPermissions = [
      ...
      'manage_inventory_admin', 'manage_purchasing', 'manage_quotes', 'manage_settings',
      ...
      'view_documents', 'view_email_kpis', 'view_emails',
      'view_inventory', 'view_jobs', 'view_materials', 'view_own_calendar', 'view_own_jobs',
      'view_profile', 'view_projects',
      'view_purchasing', 'view_quotes',
