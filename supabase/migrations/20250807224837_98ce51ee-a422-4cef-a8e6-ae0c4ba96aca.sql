-- Remove the foreign key constraint that's preventing us from using measurement IDs
ALTER TABLE windows_summary DROP CONSTRAINT IF EXISTS windows_summary_window_id_fkey;

-- Now insert the test data with measurement IDs
