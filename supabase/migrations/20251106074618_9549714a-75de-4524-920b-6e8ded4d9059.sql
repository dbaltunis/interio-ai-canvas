-- Fix the delete_user_cascade function to use correct table name (user_permissions not custom_permissions)
...
BEGIN
  ...
  -- Delete user's custom permissions (correct table name: user_permissions)
