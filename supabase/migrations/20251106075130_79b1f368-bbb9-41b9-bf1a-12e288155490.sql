-- Fix delete_user_cascade to handle all foreign key dependencies
...
BEGIN
  ...
  -- Delete or reassign account_settings (this is the foreign key issue)
  -- First check if account_settings exists for this user
