-- Fix the user permissions system by updating the accept_user_invitation function
-- to properly handle permissions and ensure invited users get correct access
