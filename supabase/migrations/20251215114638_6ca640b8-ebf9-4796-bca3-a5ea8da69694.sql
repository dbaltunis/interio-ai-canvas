-- Fix handle_new_user trigger to use correct column name for parent account
-- The user_invitations table uses 'user_id' for the inviter, not 'invited_by'
...
BEGIN
  ...
  IF FOUND THEN
    -- FIX: Use user_id instead of non-existent invited_by column
