...
import { Plus, Calendar, User, Phone, Mail, FileText, DollarSign, Clock, MessageSquare, Settings } from "lucide-react";
import { useClientActivityLog, useCreateClientActivity } from "@/hooks/useClientActivityLog";
...
export const ClientActivityLog = ({ clientId }: ClientActivityLogProps) => {
  const { data: activities, isLoading } = useClientActivityLog(clientId);
