...
export const WindowCoveringPriceCalculator = ({ 
  ...
  const [fullnessRatio, setFullnessRatio] = useState<number | null>(null); // NO hardcoded default
  const [fabricWidth, setFabricWidth] = useState<number | null>(null); // NO hardcoded 140
