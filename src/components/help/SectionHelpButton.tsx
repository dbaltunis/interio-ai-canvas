      ...
      <SheetContent side="right" className="w-full sm:max-w-xl overflow-y-auto">
        ...
        <div className="mt-6 space-y-6">
          ...
          <div className="space-y-3">
            ...
            {tutorialMap[sectionId] && tutorialMap[sectionId].steps.length > 0 && tutorialMap[sectionId].steps[0].Visual ? <TutorialCarousel steps={tutorialMap[sectionId].steps} /> : <div className="rounded-lg border border-dashed border-muted-foreground/30 p-6 text-center">
