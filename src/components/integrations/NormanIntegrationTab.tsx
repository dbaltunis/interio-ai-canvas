      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Premium shutters, blinds, and awnings supplier
          </p>
        </div>
        {integration && (
        ...
        <CardContent className="space-y-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="space-y-2">
              ...
              <Input
                id="nm_account_number"
                placeholder="Your Norman account number"
            ...
            <div className="space-y-2">
              ...
              <Input
                id="nm_supplier_email"
                type="email"
                placeholder="orders@normanaustralia.com.au"
          ...
          <CardContent className="space-y-4">
            ...
            <div className="flex gap-2">
              <Button
                ...
                disabled={isSending || !formData.account_number}
              >
