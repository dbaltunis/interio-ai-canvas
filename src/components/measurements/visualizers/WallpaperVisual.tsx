...
export const WallpaperVisual = ({
  ...
  const wallWidth = parseFloat(measurements.wall_width) || 300;
  const wallHeight = parseFloat(measurements.wall_height) || 240;
  ...
  const calculation = useMemo(() => {
    if (!wallWidth || !wallHeight) return null;
    ...
    // Calculate usable length per roll (accounting for pattern matching)
  ...
  }, [wallWidth, wallHeight, rollWidth, rollLength, patternRepeat]);
        ...
        <div className="flex flex-col items-center justify-center">
          ...
          <div className="mt-4 flex flex-wrap gap-4 justify-center text-xs">
            <div className="flex items-center gap-2">
              <div className="w-4 h-4" style={{ background: 'url(#wallpaper-pattern)' }}></div>
