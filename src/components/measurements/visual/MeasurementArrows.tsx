  ...
  const measurementConfigs = [
    {
      ...
      component: (
        <div className={`absolute ${hardwareType === "track" ? "top-4" : "top-20"} left-12 right-12 flex items-center`}>
          ...
          <div className="flex-1 border-t-2 border-blue-600 relative">
            <span className="absolute -top-10 left-1/2 transform -translate-x-1/2 bg-blue-600 text-white px-3 py-1 rounded-full text-xs font-bold shadow-lg whitespace-nowrap">
    ...
    },
    {
      ...
      component: (
        <div className="absolute top-32 left-16 right-16 flex items-center">
          ...
          <div className="flex-1 border-t-2 border-green-600 relative">
            <span className="absolute -top-10 left-1/2 transform -translate-x-1/2 bg-green-600 text-white px-3 py-1 rounded-full text-xs font-bold shadow-lg whitespace-nowrap">
    ...
    },
    {
      ...
      component: (
        <div className={`absolute ${hardwareType === "track" ? "top-10" : "top-26"} right-6 flex flex-col items-center`}>
          ...
          <div className="h-80 border-l-2 border-purple-600 relative">
            <span className="absolute -right-24 top-1/2 transform -translate-y-1/2 bg-purple-600 text-white px-3 py-1 rounded-full text-xs font-bold whitespace-nowrap shadow-lg">
    ...
    },
    {
      ...
      component: (
        <div className="absolute top-36 left-8 bottom-32 flex flex-col items-center">
      ...
      component: (
        <div className="absolute top-8 left-20 flex flex-col items-center">
          ...
          <div className="h-12 border-l-2 border-red-600 relative">
            <span className="absolute -left-24 top-1/2 transform -translate-y-1/2 bg-red-600 text-white px-3 py-1 rounded-full text-xs font-bold whitespace-nowrap shadow-lg">
    ...
    },
    {
      ...
      component: (
        <div className="absolute bottom-32 right-20 flex flex-col items-center">
          <div className="w-0 h-0 border-l-2 border-r-2 border-b-4 border-transparent border-b-indigo-600"></div>
          <div className="h-20 border-l-2 border-indigo-600 relative">
            <span className="absolute -right-24 top-1/2 transform -translate-y-1/2 bg-indigo-600 text-white px-3 py-1 rounded-full text-xs font-bold whitespace-nowrap shadow-lg">
    ...
    },
    {
      ...
      component: (
        <div className={`absolute ${hardwareType === "track" ? "top-10" : "top-26"} left-2 bottom-8 flex flex-col items-center`}>
          ...
          <div className="flex-1 border-l-2 border-pink-600 relative">
            <span className="absolute -left-28 top-1/2 transform -translate-y-1/2 bg-pink-600 text-white px-3 py-1 rounded-full text-xs font-bold whitespace-nowrap shadow-lg">
    ...
    },
    {
      ...
      component: (
        <div className="absolute bottom-4 left-12 right-12 flex items-center">
          ...
          <div className="flex-1 border-t-2 border-teal-600 relative">
            <span className="absolute -bottom-10 left-1/2 transform -translate-x-1/2 bg-teal-600 text-white px-3 py-1 rounded-full text-xs font-bold shadow-lg whitespace-nowrap">
