      ...
      <CardContent>
        <div className="flex flex-col lg:flex-row gap-6">
          ...
          <div className="flex-1 space-y-4">
            ...
            {/* Worksheet Total */}
            {fabricCalculation && selectedFabric && (
              <div className="bg-gradient-to-r from-green-50 to-emerald-50 border-2 border-green-300 rounded-lg p-4 shadow-md">
                <div className="flex items-center gap-2 mb-3">
                  ...
                  <div>
                    <h4 className="font-bold text-green-800">Worksheet Total</h4>
                    <p className="text-xs text-green-600">Final fabric requirements</p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-white/70 rounded-md p-3 border border-green-200">
                    ...
                    <div className="text-xs text-gray-500">Linear metres</div>
                  </div>
                  
                  <div className="bg-white/70 rounded-md p-3 border border-green-200">
                    <div className="text-sm font-medium text-gray-700 mb-1">Total Fabric Cost</div>
                    <div className="text-2xl font-bold text-green-700">
                      ${fabricCalculation.totalCost.toFixed(2)}
                    </div>
                    <div className="text-xs text-gray-500">At ${fabricCalculation.pricePerMeter.toFixed(2)}/m</div>
                  </div>
                </div>
              </div>
            )}
