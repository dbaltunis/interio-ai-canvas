...
const LivePreviewBlock = ({ 
  ...
  switch (blockType) {
    ...
    // NOTE: 'line-items' case is handled by the 'products' case below as an alias
    // The duplicate 'line-items' case that was here has been removed to fix the build error
    ...
    // NOTE: 'products', 'items', 'line-items' cases are handled earlier in the switch (around line 738)
    // NOTE: 'totals', 'summary', 'total' cases are handled earlier in the switch (around line 1380)
    // Duplicate cases have been removed to fix build errors
