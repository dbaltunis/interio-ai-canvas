                                ...
                                {!event.isBooking && !event.isAvailableSlot && !event.isTask && (
                                  ...
                                  <div className="flex flex-col h-full pr-1 pb-1 overflow-hidden">
                                   ...
                                   {/* Task content - distinct display */}
                                    {event.isTask && (
                                      <div 
                                        className="flex items-center gap-1.5 h-full px-1.5 py-2 cursor-pointer hover:opacity-80 transition-opacity"
                                        onClick={(e) => {
                                          e.stopPropagation();
                                      ...
                                      >
                                        ...
                                        <div className="font-medium text-[10px] leading-tight break-words flex-1 min-w-0 text-foreground" style={{
