    ...
    <div className="space-y-4">
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        <TabsList className="rounded-xl border border-border/60 bg-muted/40 p-1 grid w-full grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-1 shadow-sm backdrop-blur supports-[backdrop-filter]:backdrop-blur">
          ...
          <TabsTrigger 
            value="analytics" 
            className="flex items-center gap-1.5 px-3 py-2 text-xs md:text-sm text-muted-foreground rounded-md transition-colors hover:bg-muted/50 data-[state=active]:bg-background data-[state=active]:text-foreground data-[state=active]:shadow-sm lg:flex"
          >
            <BarChart3 className="w-3 h-3 md:w-4 md:h-4" />
