...
const OnboardingWizard = () => {
  ...
  return <div className="min-h-screen bg-background">
      ...
      <div className="max-w-5xl mx-auto px-4 py-6">
        <WizardProgress currentStep={wizard.currentStep} totalSteps={wizard.totalSteps} steps={wizard.steps} completionStatus={wizard.completionStatus} onStepClick={wizard.goToStep} />
      </div>
      ...
      {/* Navigation Footer */}
      <WizardNavigation currentStep={wizard.currentStep} totalSteps={wizard.totalSteps} onNext={wizard.nextStep} onPrev={wizard.prevStep} isSaving={wizard.isSaving} isFirstStep={wizard.currentStep === 0} isLastStep={wizard.currentStep === wizard.totalSteps - 1} />
    </div>;
};
