      ...
      for (const summary of summaries) {
        ...
        if (fabricId && summary.linear_meters > 0) {
          ...
          if (fabricData) {
            ...
            const quantity = (fabricData as any).quantity;
            ...
            if (name) {
              ...
              materials.push({
                ...
                lowStock: (quantity || 0) < usedMeters
              });
            }
          }
        }
        ...
        if (hardwareId) {
          ...
          if (hardwareData) {
            ...
            const quantity = (hardwareData as any).quantity;
        ...
        if (headingId) {
          ...
          if (headingData) {
            ...
            const quantity = (headingData as any).quantity;
